...
Owned element IDs: `contextMenu`, `cmModeParent`, `cmSubmenu`, `cmCheckSelect`, `cmCheckAdd`, `cmCheckConnect`, `cmCheckMove`, `cmInvertFold`, `cmEdgeTypeParent`, `cmEdgeTypeSubmenu`, `cmCheckEdgeNormal`, `cmCheckEdgeResidual`, `cmCheckEdgeSkip`, `cmEdit`, `cmEditText`, `cmCopy`, `cmCopyText`, `cmPaste`, `cmPasteText`, `cmDelete`, `cmDeleteText`.

### [edit-edge.html](./edit-edge.html)

Connection editor and routing selection.

Owned element IDs: `editEdgeModal`, `editEdgeTypeBadge`, `editEdgeNodesBanner`, `editEdgeFromLabel`, `editEdgeToLabel`, `cardNormal`, `radioNormal`, `cardResidual`, `radioResidual`, `cardSkip`, `radioSkip`, `editEdgeFoldSelect`.
...
Owned element IDs: `fileMenuBtn`, `fileMenuDropdown`, `menuWorkingDir`, `modelTitle`, `modelTitleInput`, `appModeTabs`, `headerEdgeToolbar`, `headerEdgeTitle`, `headerEdgeNodes`, `hdrBtnNormal`, `hdrBtnResidual`, `hdrBtnSkip`, `btnSaveModel`.
