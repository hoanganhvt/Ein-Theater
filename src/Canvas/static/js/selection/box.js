import { nodesInRectangle } from './hitTest.js';
...
export function setupBoxSelection() {
    ...
    window.addEventListener('mousemove', (e) => {
        ...
        const newlySelected = nodesInRectangle(minX, minY, maxX, maxY);
    ...
    window.addEventListener('mouseup', (e) => {
        ...
        if (wasDragged && state.network) {
            ...
            const newlySelected = nodesInRectangle(minX, minY, maxX, maxY).map(String);
